...
**当前状态**
- 根仓库 `main...origin/main` 当前本地新增未提交修复：`scripts/bootstrap_engine_min_deps.sh`、`handoff.md`。
...
**下一步**
1. 提交并 push OpenJDK macOS layout 校验修复，commit message 建议 `fix: accept macos openjdk layout`。
