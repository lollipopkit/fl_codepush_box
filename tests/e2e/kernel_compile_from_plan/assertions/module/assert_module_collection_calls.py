...
def assert_collection_calls(module):
    ...
    def assert_collection_try_await_module(name, opcodes, constants, param_count, min_awaits=0):
        function = next(item for item in module["functions"] if item["name"].endswith(f"::{name}"))
        assert function["async_kind"] == "async_future", function
        assert function["param_count"] == param_count, function
    ...
    assert_collection_try_await_module(
        ...
        [
            ...
            "patched-await-then-collection-try-catch-finally-await-list-caught-",
    ...
    assert_collection_try_await_module(
        ...
        [0x62, 0x03, 0x41, 0x51, 0x55, 0x63],
        [
            "patched-await-then-collection-try-catch-await-map",
    ...
    assert_collection_try_await_module(
        ...
        [0x62, 0x03, 0x41, 0x51, 0x55, 0x63],
        [
            "patched-await-then-collection-try-finally-await-map",
    ...
    assert_collection_try_await_module(
        ...
        [0x62, 0x03, 0x41, 0x51, 0x55, 0x63],
        [
            "patched-await-then-collection-try-catch-finally-await-map",
            "patched-await-then-collection-try-catch-finally-await-map-caught-",
    ...
    assert_collection_try_await_module(
        ...
        [0x62, 0x03, 0x40, 0x51, 0x55, 0x63],
        [
            "patched-double-await-collection-try-catch-await-list-head-",
    ...
    assert_collection_try_await_module(
        ...
        [0x62, 0x03, 0x40, 0x51, 0x55, 0x63],
        [
            "patched-double-await-collection-try-finally-await-list-head-",
    ...
    assert_collection_try_await_module(
        ...
        [0x62, 0x03, 0x40, 0x51, 0x55, 0x63],
        [
            "patched-double-await-collection-try-catch-finally-await-list-head-",
            "patched-double-await-collection-try-catch-finally-await-list-caught-",
    ...
    assert_collection_try_await_module(
        ...
        [0x62, 0x03, 0x41, 0x51, 0x55, 0x63],
        [
            "patched-double-await-collection-try-catch-await-map-",
    ...
    assert_collection_try_await_module(
        ...
        [0x62, 0x03, 0x41, 0x51, 0x55, 0x63],
        [
            "patched-double-await-collection-try-finally-await-map-",
    ...
    assert_collection_try_await_module(
        ...
        [0x62, 0x03, 0x41, 0x51, 0x55, 0x63],
        [
            "patched-double-await-collection-try-catch-finally-await-map-",
            "patched-double-await-collection-try-catch-finally-await-map-caught-",
