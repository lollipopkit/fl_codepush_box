...
def assert_async_loop_sources(patch_by_member):
    ...
    assert_multi_update_combo_source(
        "asyncForMultiAwaitUpdateNestedBranchLocal",
        [
            "patched-for-multi-await-update-nested-branch",
            "patched-for-multi-await-update-nested-pro",
            "patched-for-multi-await-update-nested-basic",
            "patched-for-multi-await-update-nested-tail",
        ],
        awaits=["ready", "nextI", "nextJ"],
    )
    assert_multi_update_combo_source(
