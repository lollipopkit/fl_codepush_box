...
Future<String> asyncGuardedSwitchStatementLabel(
  ...
  return enabled
      ? 'base-async-guarded-switch-stmt-$tier'
      : 'base-async-guarded-switch-stmt-other';
}
...
Future<String> asyncAwaitThenGuardedSwitchStatementLabel(
  ...
  final tier = await ready;
  return enabled
      ? 'base-await-guarded-switch-stmt-$tier'
      : 'base-await-guarded-switch-stmt-other';
}
...
Future<String> asyncAwaitConditionSwitchStatementTryCatchRecoveryLabel(
  ...
  if (tier == 'blocked') {
    ...
    return 'base-await-condition-switch-stmt-try-catch-caught-$label';
  }
  return 'base-await-condition-switch-stmt-try-catch-$tier';
}
...
Future<String> asyncAwaitConditionSwitchStatementTryFinallyCleanupLabel(
  ...
  final tier = await ready;
  await cleanup;
  return 'base-await-condition-switch-stmt-try-finally-$tier';
}
...
Future<String> asyncAwaitThenSwitchStatementTryCatchRecoveryLabel(
  ...
  if (tier == 'blocked') {
    final label = await recovery;
    return 'base-await-then-switch-stmt-try-catch-caught-$label';
  }
  return 'base-await-then-switch-stmt-try-catch-$tier';
}
...
Future<String> asyncAwaitThenSwitchStatementTryFinallyCleanupLabel(
  ...
  final tier = await ready;
  await cleanup;
  return 'base-await-then-switch-stmt-try-finally-$tier';
}
...
Future<String> asyncDoubleAwaitSwitchStatementTryCatchFinallyRecoveryLabel(
  ...
  if (tier == 'blocked') {
    final label = await recovery;
    await cleanup;
    return 'base-double-await-switch-stmt-try-catch-finally-caught-$label';
  }
  await cleanup;
  return 'base-double-await-switch-stmt-try-catch-finally-$tier';
}
...
Future<String> asyncDoubleAwaitSwitchStatementTryFinallyCleanupLabel(
  ...
  final tier = await ready;
  await cleanup;
  return 'base-double-await-switch-stmt-try-finally-$tier';
}
...
Future<String> asyncSwitchStatementAwaitGuardLabel(
  ...
  if (await enabled) {
    return 'base-switch-stmt-await-guard-$tier';
  }
  return 'base-switch-stmt-await-guard-other';
}
...
Future<String> asyncAwaitThenSwitchStatementAwaitGuardLabel(
  ...
  final tier = await ready;
  if (await enabled) {
    return 'base-await-switch-stmt-await-guard-$tier';
  }
  return 'base-await-switch-stmt-await-guard-other';
}
