...
Stream<String> asyncGeneratedDynamicForInContinueAfterYield(
  List<String> extra,
) async* {
...
Stream<String> asyncGeneratedDynamicForInBreakAfterYield(
  List<String> extra,
) async* {
...
Stream<String> asyncGeneratedDynamicForInContinueThenBreak(
  List<String> extra,
) async* {
...
Stream<String> asyncGeneratedDynamicForInContinueYieldBreak(
  List<String> extra,
) async* {
...
Stream<String> asyncGeneratedDynamicForInNestedBreakContinue(
  List<String> extra,
  List<String> suffixes,
) async* {
...
Stream<String> asyncGeneratedYieldStarFromFuture(String value) async* {
  yield* Stream.fromFuture(
    Future.value('patched-stream-yield-star-future-$value'),
  );
}
...
Stream<String> asyncGeneratedAwaitForPendingFuture(
  Future<String> ready,
) async* {
...
Stream<String> asyncGeneratedAwaitForFromIterableCatchFinally(
  List<String> extra,
) async* {
  try {
    try {
...
Stream<String> asyncGeneratedAwaitForFutureCatchFinally(String value) async* {
  try {
    try {
      await for (final item in Stream.fromFuture(
        Future.value('patched-stream-await-for-future-catch-$value'),
      )) {
...
Stream<String> asyncGeneratedAwaitForPendingFutureCatchFinally(
  Future<String> ready,
) async* {
  try {
    try {
...
Stream<String> asyncGeneratedAwaitForFutureBreakCatchFinally(
  String value,
) async* {
  try {
    try {
...
Stream<String> asyncGeneratedAwaitForPendingContinueCatchFinally(
  Future<String> ready,
) async* {
  try {
    try {
...
Stream<String> asyncGeneratedYieldStarStreamFinally(
  Stream<String> extra,
) async* {
  try {
    yield* extra;
...
Stream<String> asyncGeneratedYieldStarStreamCatchFinally(
  Stream<String> extra,
) async* {
  try {
    try {
...
Stream<String> asyncGeneratedYieldStarStreamCatchAwaitRecovery(
  Stream<String> extra,
  ...
  try {
    ...
    yield 'patched-stream-yield-star-stream-catch-await-caught-$marker-$e';
  }
}

Stream<String> asyncGeneratedYieldStarStreamFinallyAwaitCleanup(
  Stream<String> extra,
  ...
  try {
    ...
    yield 'patched-stream-yield-star-stream-finally-await-cleanup-$marker';
  }
}

Stream<String> asyncGeneratedYieldStarStreamCatchFinallyAwaitRecovery(
  Stream<String> extra,
  Future<String> recovery,
  Future<String> cleanup,
) async* {
  try {
    try {
      ...
      final marker = await recovery;
      yield 'patched-stream-yield-star-stream-catch-finally-await-caught-$marker-$e';
    }
  } finally {
    final marker = await cleanup;
    yield 'patched-stream-yield-star-stream-catch-finally-await-cleanup-$marker';
  }
}

Stream<String> asyncGeneratedYieldStarTwoStreamsCatchFinally(
  Stream<String> first,
  Stream<String> second,
) async* {
  try {
...
Stream<String> asyncGeneratedYieldStarTwoStreamsCatchAwaitRecovery(
  Stream<String> first,
  Stream<String> second,
  Future<String> recovery,
) async* {
  try {
    ...
    final marker = await recovery;
    yield 'patched-stream-yield-star-two-streams-catch-await-caught-$marker-$e';
  }
}

Stream<String> asyncGeneratedYieldStarTwoStreamsFinallyAwaitCleanup(
  Stream<String> first,
  Stream<String> second,
  Future<String> cleanup,
) async* {
  try {
    ...
    final marker = await cleanup;
    yield 'patched-stream-yield-star-two-streams-finally-await-cleanup-$marker';
  }
}

Stream<String> asyncGeneratedYieldStarTwoStreamsCatchFinallyAwaitRecovery(
  Stream<String> first,
  Stream<String> second,
  Future<String> recovery,
  Future<String> cleanup,
  ...
  try {
    try {
      ...
      final marker = await recovery;
      yield 'patched-stream-yield-star-two-streams-catch-finally-await-caught-$marker-$e';
    }
  } finally {
    final marker = await cleanup;
    yield 'patched-stream-yield-star-two-streams-catch-finally-await-cleanup-$marker';
  }
}

Stream<String> asyncGeneratedYieldStarDynamicCatchFinally(
  List<String> extra,
) async* {
  try {
    try {
...
Stream<String> asyncGeneratedYieldStarFromFutureCatchFinally(
  String value,
) async* {
  try {
    try {
      yield* Stream.fromFuture(
        Future.value('patched-stream-yield-star-future-catch-$value'),
      );
    } catch (e) {
...
Stream<String> asyncGeneratedYieldStarPendingFutureCatchFinally(
  Future<String> ready,
) async* {
  try {
    try {
...
Stream<String> asyncGeneratedYieldStarStreamSandwichCatchFinally(
  Stream<String> extra,
) async* {
  try {
    try {
...
Stream<String> asyncGeneratedYieldStarTwoStreamsSandwichCatchFinally(
  Stream<String> first,
  Stream<String> second,
) async* {
  try {
...
Stream<String> asyncGeneratedYieldStarTripleStreamsCatchFinally(
  Stream<String> first,
  Stream<String> second,
  Stream<String> third,
) async* {
...
Stream<String> asyncGeneratedYieldStarTripleStreamsCatchAwaitRecovery(
  Stream<String> first,
  Stream<String> second,
  Stream<String> third,
  Future<String> recovery,
  ...
  try {
    ...
    final marker = await recovery;
    yield 'patched-stream-yield-star-triple-streams-catch-await-caught-$marker-$e';
  }
}

Stream<String> asyncGeneratedYieldStarTripleStreamsFinallyAwaitCleanup(
  Stream<String> first,
  Stream<String> second,
  Stream<String> third,
  Future<String> cleanup,
  ...
  try {
    ...
    final marker = await cleanup;
    yield 'patched-stream-yield-star-triple-streams-finally-await-cleanup-$marker';
  }
}

Stream<String> asyncGeneratedYieldStarTripleStreamsCatchFinallyAwaitRecovery(
  Stream<String> first,
  Stream<String> second,
  Stream<String> third,
  Future<String> recovery,
  ...
  try {
    try {
      ...
      final marker = await recovery;
      yield 'patched-stream-yield-star-triple-streams-catch-finally-await-caught-$marker-$e';
    }
  } finally {
    final marker = await cleanup;
    yield 'patched-stream-yield-star-triple-streams-catch-finally-await-cleanup-$marker';
  }
}
...
Stream<String> asyncGeneratedAwaitForStreamContinue(
  Stream<String> extra,
) async* {
  await for (final value in extra) {
    if (value == 'skip') continue;
...
Stream<String> asyncGeneratedAwaitForStreamCatchFinally(
  Stream<String> extra,
) async* {
  try {
    try {
...
Stream<String> asyncGeneratedAwaitForStreamCatchAwaitRecovery(
  Stream<String> extra,
  Future<String> recovery,
) async* {
  try {
    await for (final value in extra) {
      yield 'patched-stream-await-for-stream-catch-await-body-$value';
    }
  } catch (e) {
    final marker = await recovery;
    yield 'patched-stream-await-for-stream-catch-await-caught-$marker-$e';
  }
}

Stream<String> asyncGeneratedAwaitForStreamFinallyAwaitCleanup(
  Stream<String> extra,
  Future<String> cleanup,
) async* {
  try {
    await for (final value in extra) {
      yield 'patched-stream-await-for-stream-finally-await-body-$value';
    }
  } finally {
    final marker = await cleanup;
    yield 'patched-stream-await-for-stream-finally-await-cleanup-$marker';
  }
}

Stream<String> asyncGeneratedAwaitForStreamCatchFinallyAwaitRecovery(
  Stream<String> extra,
  Future<String> recovery,
  Future<String> cleanup,
) async* {
  try {
    try {
      await for (final value in extra) {
        yield 'patched-stream-await-for-stream-catch-finally-await-body-$value';
      }
    } catch (e) {
      final marker = await recovery;
      yield 'patched-stream-await-for-stream-catch-finally-await-caught-$marker-$e';
    }
  } finally {
    final marker = await cleanup;
    yield 'patched-stream-await-for-stream-catch-finally-await-cleanup-$marker';
  }
}

Stream<String> asyncGeneratedAwaitForTwoStreamsCatchFinally(
  Stream<String> first,
  Stream<String> second,
) async* {
  try {
...
Stream<String> asyncGeneratedAwaitForNestedStreamCatchFinally(
  Stream<String> outer,
  Stream<String> inner,
) async* {
  try {
...
Stream<String> asyncGeneratedAwaitForNestedStreamBreakContinueCatchFinally(
  Stream<String> outer,
  Stream<String> inner,
) async* {
  try {
...
Stream<String> asyncGeneratedAwaitForTripleNestedStreamCatchFinally(
  Stream<String> outer,
...
Stream<String> asyncGeneratedAwaitForNestedStreamBreakContinueFinally(
  Stream<String> outer,
  Stream<String> inner,
) async* {
  try {
...
Stream<String> asyncGeneratedAwaitForTripleNestedStreamFinally(
  Stream<String> outer,
  Stream<String> middle,
  Stream<String> inner,
) async* {
...
Stream<String> asyncGeneratedGuardedSwitchExpr(
  String tier,
  bool enabled,
) async* {
  yield switch (tier) {
    'gold' when enabled => 'patched-stream-guarded-switch-gold',
    'vip' when enabled => 'patched-stream-guarded-switch-vip',
    _ => 'patched-stream-guarded-switch-other',
  };
}

Stream<String> asyncGeneratedGuardedSwitchStatement(
  String tier,
  bool enabled,
) async* {
  switch (tier) {
    case 'gold' when enabled:
      yield 'patched-stream-guarded-switch-stmt-gold';
    case 'vip' when enabled:
      yield 'patched-stream-guarded-switch-stmt-vip';
    default:
      yield 'patched-stream-guarded-switch-stmt-other';
  }
}
