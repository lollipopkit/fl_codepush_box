...
require_line "$KERNEL_SUMMARY" "interpreted_count: 463"
require_line "$KERNEL_SUMMARY" "reject_count: 2"
require_line "$KERNEL_SUMMARY" "unchanged_count: 13"
require_line "$KERNEL_SUMMARY" "module_function_count: 478"
require_line "$KERNEL_SUMMARY" "binary_function_count: 478"
