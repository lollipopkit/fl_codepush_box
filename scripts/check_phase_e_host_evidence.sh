...
require_line "$KERNEL_SUMMARY" "interpreted_count: 508"
require_line "$KERNEL_SUMMARY" "reject_count: 2"
require_line "$KERNEL_SUMMARY" "unchanged_count: 13"
require_line "$KERNEL_SUMMARY" "module_function_count: 523"
require_line "$KERNEL_SUMMARY" "binary_function_count: 523"
